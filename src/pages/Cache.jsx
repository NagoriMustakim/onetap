        ...
        <div className='d-flex flex-column mb-3 faq-cont' style={{ background: "#FFEEF7", fontFamily: "Montserrat" }}>
            ...
            <div className="outer-container">
                <div className="inner-container">
                    ...
                    <p style={{ textAlign: "center", marginTop: "71px" }}>WARPVPN’s Purge Cache tool allows you to refresh WARPVPNS's DNS cache for domain names. To refresh the cache for a domain name, enter the name for the domain below, pick the DNS record type and then hit the Purge Cache.</p>
